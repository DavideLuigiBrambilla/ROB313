...
def checkFundamental(pts1, pts2, F_7, err):
	x = []
	x_prime = []
	verif = []
...
for SampleSize in range(N):
	...
	F_7, nb_inliners, pts1_7, pts2_7, inliner_pts1, inliner_pts2 = Run_7points (pts1, pts2, 1.5)
	...
	F_7_2, nb_inliners_2, pts1_7_2, pts2_7_2, inliner_pts1_2, inliner_pts2_2 = Run_7points (inliner_pts1_2, inliner_pts2_2, 1)
